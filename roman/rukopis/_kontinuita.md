# Kontinuita rukopisu — *Prach a soulad*

Pracovní soubor pro návaznost mezi kapitolami. Každá kapitola si připíše
sekci. Příští kapitoly z toho čtou, aby neporušily fakta, jména a tvary.

---

## Kap. 1 — „Léčka v dunách"

**POV:** plk. Adan Reyever (vševědoucí 3. os., přítomný čas). Vedlejší ohnisko: št. rtm. Brannick „Kovář" Hale.

**Místo:** pouštní kolonie **Sirte**. Konkrétně kotlina s **vodním kolektorem** (kruhové síto na sběr noční rosy, betonová nádrž, plechový přístřešek) mimo město. Orbitální výtah a hlavní vodní rozvod jsou jinde ve městě (tam je Vos — viz níže).

**Denní doba:** poslední hodina noci → úsvit. Akce začíná s východem slunce. Konec krátce po ránu, slunce už hřeje.

**Jmenované postavy v kapitole (přesné tvary):**
- **plk. Adan Reyever** — velitel, padesátník, mluví úsporně; pravidlo „poprvé posloucháš, podruhé varování, potřetí rozkaz".
- **št. rtm. Brannick „Kovář" Hale** — veterán-technik, černý humor, řemeslné metafory, obecná čeština.
- **por. Daré** — velitelka druhého družstva (žena), úsečná, profesionální. Uzavírá západní stranu kotliny.
- **Vejvar** — nováček (voják), zmíněn u vnitřní sázky; „seš nový".
- **mjr. Iliana Vos** — NEvystupuje fyzicky, jen ve zmínce: je toho dne na druhé straně města u **orbitálního výtahu** a hlídá vodu/výtah. (Plně nastupuje až kap. 3.)
- **Cassia Renn** — NEvystupuje, jen zmíněna: zadala briefing, použila slovo „povstalci" třikrát, vidí v Legii nástroj. (Nastupuje kap. 2.)

**Klíčové události:**
1. Reyeverova rota se 5 hodin tiše plíží dunami od vysazení z bezmotorových kluzáků (žádný teplotní podpis), obklíčí kolektor.
2. Devět „povstalců" (ve skutečnosti vodní farmáři/kolonisti) hlídá kolektor; nelegálně napíchli vodní vedení do vlastních kanystrů — „krádež s puškama".
3. Reyever vydá rozkaz: zadržení, ne masakr; živé, pokud to dovolí. Útok časuje na okamžik, kdy slunce svítí obráncům do očí.
4. Přepad: kuřáka na střeše sundá operátor těžké pušky první ranou; dva u nádrže padnou v pasti; tři u betonového žlabu vyplýtvají munici panikou a vzdají se (jeden mladík sáhne po pistoli, zastřelí ho Hale).
5. Hale vymámí dva ukryté v boudě ven blafem s plynovou láhví — vyřešeno slovem.
6. Aftermath: Reyever obchází mrtvé, pozná že nejsou vojáci.
7. Starší zajatec pronese naučenou frázi: „přešli jsme na správnou stranu… bráníte mrtvolu" — cizí slova v cizí puse (předznamenává Smíření/Soulad).
8. **HOOK:** u padlého mladíka najdou zbraň z neznámé slitiny.

**Ztráty:**
- Nepřítel: 5 mrtvých, 4 zajatí (2 u žlabu + 2 z boudy; jeden raněný u nádrže dýchá, ošetřován). Pozn.: text na jednom místě uvádí „dva zajatí" hned po boji, pak +2 z boudy = celkem 4 zajatí.
- Legie: 0 ztrát, ani škrábnutí.

**Zavedené konkrétní detaily / termíny (držet dál):**
- **vodní kolektor** na Sirte = kruhové síto na noční rosu + betonová nádrž (jediná cennost planety = voda + orbitální výtah; proto se válčí pěšky, ne z orbity — viz bible).
- **kluzáky** Legie = bezmotorové sestupové prostředky pro tichý výsadek (žádný teplotní záblesk).
- **koloniální „služební pětky"** = běžné ojeté kondominijní pušky na pohraničí (rodový termín pro standardní lidskou výzbroj).
- Reyeverovo velitelské pravidlo: poprvé poslech / podruhé varování / potřetí rozkaz; nikdy nezvyšuje hlas.
- Halova pověra: mění plný zásobník před akcí = „dát stroji najevo, že to myslíš vážně".
- Vnitřní (uzavřený) **kanál/pásmo** Legie vs. velitelské pásmo — vojáci na něm sázejí, kolik bude mrtvých.
- Naučená fráze nepřátel: „přešli jsme na správnou stranu / bráníte mrtvolu" (ideologie Smíření, ještě nepojmenovaná).

**CIZÍ VÝZBROJ (nosný hook celé série — přesný popis pro návaznost):**
- ruční palná zbraň, **bez viditelného závěru a bez zásobníku na náboje**.
- materiál: **matný, bez lesku, barvy mokré břidlice**; povrch hladký, plynulá křivka místo chladicího žebrování — „jako by nebyla sestavená, ale narostlá".
- **výrazně lehčí**, než vypadá.
- po zaklepání **tlumený, „plný" zvuk** (žádná dutina uvnitř).
- **žádné značení**: bez sériového čísla, bez výrobce, bez země původu.
- Hale: „to není ocel ani žádná slitina, kterou znám… tohle vyrostlo."
- Zabaleno do pytle na důkazy zvlášť, nikdo se toho nedotýká holou rukou. (V kap. 7 z toho Vos tajně bere vzorek; v kap. 5 na tom Hale najde nelidské značení.)

**Jak kapitola končí:**
Reyever zabalí cizí zbraň do pytle na důkazy, Daré se ptá „co to teda je?" a Reyever odpoví: „To je špatná otázka." Závěrečný obraz: písek vsákne vylitou vodu — „drží se všeho, a přesto si nikdy nic nenechá."
...
**Klíčové události:**
1. Briefing Reyever × Renn. Renn chválí „čistou práci", zaokrouhluje na „9 zadržených, 0 ztrát"; Reyever opraví na **5 mrtvých, 4 zadržení** (drží čísla z kap. 1).
...
**POV:** mjr. Iliana Vos (vševědoucí 3. os., přítomný čas; ohnisko pevně u Vos, žádný střih do jiného POV). Toto je první kapitola, kde Vos vystupuje fyzicky a kde ji čtenář pozná naplno.

**Místo:** město **Sirte**, **druhá strana města** než kap. 1/2 — **rozvodný uzel Sirte-západ**: křižovatka/náměstí pod **orbitálním výtahem**, s **čerpací stanicí** (nízká betonová krabice, plochá střecha, tři okna proměněná ve střílny) a **rozvodnou věží** (na střeše odstřelovač). Boj o vodu a výtah pěšky, ne z orbity.

**Denní doba / čas:** **TÝŽ DEN, táž operace jako kap. 1** (úsvit → dopoledne). Souběžně s Reyeverovým přepadem kolektoru v kotlině. Explicitně v textu: tentýž den, tentýž úsvit, Reyever dělá totéž (obchází těla farmářů) na druhé straně města — ale Vos to neví.

**Jmenované postavy v kapitole (přesné tvary):**
- **mjr. Iliana Vos** — POV; velitelka pozemní operace na západní straně. Tvrdá, přímá, profesionální; když je naštvaná, ZTIŠÍ se, ne zesílí. Obchází mrtvé nepřátele (i cizí), aby věděla, koho zabila — „jediná počestnost, kterou si může dovolit".
- **plk. Adan Reyever** — NEvystupuje fyzicky; jen HLAS po velitelském pásmu. Volací znak Vos je **„Volání jedna"**. Dá rozkaz zastavit útok a stáhnout se, **odmítne uvést důvod** („Žádný důvod neuvádím.").
- **des. Holan** — mladý desátník z Vosiny čety; padne hned na začátku boje (odstřelovač z věže).
- **svob. Sálová** (žena) — z Vosiny čety, u Vos dva roky, věcná odstřelovačka; ze 300 m sundá nepřátelského odstřelovače na věži. Přežívá, kryje ústup.
- Bezejmenní padlí z Vosiny čety: 1 svobodník s probitým pancířem cizí zbraní; +1 raněný umírá při ústupu.

**Klíčové události:**
1. Vos drží/dobývá rozvodný uzel Sirte-západ; obránci („farmáři") střílejí kázeňsky a šetří munici — to Vos zarazí (faleš povstání, ozvěna kap. 1/2).
2. Vos po pásmu žádá potvrzení pravidel nasazení; velitelství potvrdí **„bez orbitální podpory"** (důvod: orbitální palba by zničila vodu/uzel/výtah = jedinou cennost planety — viz bible).
3. Des. Holan dostane rozkaz sundat odstřelovače na věži a je při přesunu zabit.
4. Vos pomocí návnady (2 muži + nacvičená panika) vyláká odstřelovače k druhé chybě; Sálová ho z věže sundá. Věž čistá.
5. Při postupu Vos poprvé vidí **cizí zbraň v akci**: probije bojový pancíř (čistý otvor, okraje jako roztavené sklo); padne jí svobodník vedle.
6. **Reyever po pásmu nařídí Vos ZASTAVIT útok 3 minuty před průlomem a stáhnout se z náměstí**, na němž už leží 2 mrtví. **Důvod odmítne sdělit** i na přímou žádost. Vos uposlechne (pravidlo poprvé-posloucháš / podruhé-varování).
7. Po 20 min se ukáže důvod fakticky, ne slovem: stanici dobylo **druhé úderné družstvo zezadu**, bočním průchodem, kterým chtěla projít Vos — Reyeverův plán Vos čelem fixoval obranu. Vyšlo to, stálo míň lidí než Vosin plán. **Reyever jí to ale nikdy nevysvětlil** → zárodek nevyřčené zášti.
8. Aftermath: Vos obchází mrtvé. Nejsou to vojáci (ruce, boty, mladí i staří) — farmáři. Mezi nimi 3–4 cizí zbraně beze značky.
9. **HOOK:** umírající kolonista u paty věže prosí Vos: **„Nechte nás… přejít na správnou stranu."** — táž naučená fráze jako u zajatce v kap. 1 (Vos ji ale neslyšela, neví o ní). Vos pozná „naučenou modlitbu". Zeptá se „Na kterou stranu? Kdo vám to řekl?" — kolonista umře bez odpovědi. Pointa: Vos přestane řešit nevysvětlený rozkaz; začne ji zajímat, **kdo umírajícím farmářům slibuje strany.**

**Ztráty (Vosina strana):**
- des. Holan (odstřelovač z věže), bezejmenný svobodník (cizí zbraň, probitý pancíř), +1 raněný umírá při ústupu. Celkem ~3 mrtví, několik raněných.
- Nepřítel: stanice dobyta, řada mrtvých farmářů + cizí zbraně na bojišti; zajatci nespecifikováni.

**Co kdo ví (stav na konci kap. 3):**
- **Vos ví:** že „farmáři" mají cizí zbraně schopné probít bojový pancíř; že fráze „přejít na správnou stranu" je naučená (cizí věta v cizí puse); že Reyeverův rozkaz stál životy a NEBYL vysvětlen, ač měl fakticky důvod. NEVÍ o totožné scéně/frázi u Reyevera v kotlině; NEVÍ o existenci 2. úderného družstva předem.
- **Vos NEVÍ** (důležité pro návaznost): že tentýž den Reyever řešil totéž na druhé straně města; o cizí zbrani už ví Reyever a Renn z kap. 1/2; že jí Reyever posílá cizí zbraň na rozbor (kap. 2) — to se propojí později.
- **Reyever** drží svůj plán/mlčení záměrně (kapitola naznačuje jeho zásadu: velitel, který vysvětluje, je velitel, kterého lze přemluvit).

**Nové zavedené detaily / termíny (držet dál):**
- Volací znak Vos: **„Volání jedna"**; radiový pozdrav „Konec".
- **rozvodný uzel Sirte-západ**, **čerpací stanice**, **rozvodná věž** — lokace boje o vodu na západní straně města pod orbitálním výtahem.
- **des. Holan** (mladý desátník Vosiny čety) — padne v kap. 3.
- **svob. Sálová** — odstřelovačka Vosiny čety, přežívá; potenciál pro další kapitoly.
- Pravidlo nasazení na povrchu: **„bez orbitální podpory"** — protože palba zničí vodu/uzel/výtah (kanonický důvod, proč se válčí pěšky).
- Cizí zbraň v boji: bez ústí/plamene, jen „tlumené plivnutí"; **probíjí bojový pancíř — čistý otvor, okraje jako roztavené sklo** (rozšiřuje popis z kap. 1: lehčí než vypadá, barva mokré břidlice, beze značky).
- Vosin charakterový podpis: **když je naštvaná, ZTIŠÍ se**; obchází mrtvé (i cizí), aby věděla, koho zabila; respektuje Reyevera ZÁROVEŇ ho nenávidí.
- Reyeverovo velitelské pravidlo (sdílené s kap. 1) platí i vůči Vos: poprvé posloucháš / podruhé varování / potřetí rozkaz; nikdy nezvyšuje hlas.
- Naučená fráze nepřátel potvrzena podruhé a v ústech jiného kolonisty: **„nechte nás přejít na správnou stranu"** (ideologie Smíření, ještě nepojmenovaná; ozvěna kap. 1).

**Jak kapitola končí:**
Umírající kolonista pronese naučenou frázi „nechte nás přejít na správnou stranu", umře bez odpovědi na Vosiny otázky („Na kterou stranu? Kdo vám to řekl?"). Vos se zvedne; přestává ji zajímat nevysvětlený rozkaz. Závěrečná pointa: **„Zajímá ji, kdo tady umírajícím farmářům slibuje strany."**

**Otevřené nitky pro další kapitoly:**
- **Vos ↔ Reyever:** zárodek nevyřčené zášti — nevysvětlený rozkaz, který stál životy její čety (kanonické jádro vztahu dle postavy.md). Eskaluje (kap. 5 první otevřená trhlina; kap. 19 Vos konečně pochopí cenu mlčení).
- **Naučená fráze „přejít na správnou stranu"** zaznívá podruhé (kap. 1 = zajatec u Reyevera, kap. 3 = kolonista u Vos) — předznamenává Smíření; Vos teď aktivně chce vědět, kdo ji farmářům vkládá do úst.
...
> **AKT III (SOULAD).** Politická/charakterní (dechová) kapitola po ideové kap. 16. Navazuje bezprostředně: **9. den oprav** *Kovadliny*, **den po** přímém hlasu Souladu (kap. 16). Žádný boj — napětí drží podtext, vnitřní krize Legie a morální šeď. KLÍČOVÉ: plný obraz štěpení lidstva (Věrní × Smíření), Smíření má v číslech PRAVDU (Vos to musí unést), nepřítel je i LIDSKÝ. HOOK: Renn se vrací OTEVŘENĚ jako vyjednavačka Smíření.

**POV:** mjr. Iliana Vos (hlavní ohnisko, vševědoucí 3. os., přítomný čas). Vedlejší ohniska přes scénické střihy: Hale (jídelna), mužstvo (hangár), Reyever jen jako hlas/přítomnost (mapové stání), NE jako POV. Renn jen hlas v závěru (z člunu).

**Místo:** těžký křižník **Kovadlina** v opravách (klidná voda, tři týdny od nejbližší hvězdy). Lokace: **navigační kabina** (registr kolonií, jediný pult) → **důstojnická jídelna** (kovový stůl, konvice) → **mapové stání** (prázdná červená mapa, Reyever) → **velitelské stání** (depeše z jádra) → **hangár za odstavenými transportéry** (mužstvo) → zpět **velitelské stání / můstek** (volání Renn).

**Denní doba / čas:** 9. den oprav; den po hlasu Souladu (kap. 16). Kapitola = jedna noc do rána (Vos nespí devátou noc → ráno přiletí Renn).

**Jmenované postavy (přesné tvary):**
- **mjr. Iliana Vos** — POV; nespí devátou noc, chodí po lodi a počítá; naštvaná = ZTIŠÍ se; pozná „setinu vteřiny, kdy tělo dohání tvář" (od Reyevera, nenávidí to); jde mezi mužstvo do hangáru (věc, kterou major nedělá). Nese poznání, že Smíření má pravdu, ale nese ji sama.
- **plk. Adan Reyever** — vedlejší (mapové stání), NE POV; úsporný, neodpoví přímo na nic; prasklé žebro z kap. 13 stále bodá (časová kotva). Klíčová formule: nenabízí lepší čísla, ale **„jiný výsledek ze stejných"**. Pustil hlas Souladu nahlas schválně (z kap. 16) — zde důvod: „postavit hlas proti matematice = prohra; tak dává mužstvu totéž, co má sám".
- **št. rtm. Brannick „Kovář" Hale** — vedlejší (jídelna); obecná čeština, řemeslné metafory (most/trhlina/svářečka; počtář spočítá KDY most spadne, ne JESTLI stojí za to ho podržet). Přiznává, že Sarn má pravdu v číslech a že ho to „sere"; otevřel Vos neevidovaný kanál k registru Kondominia.
- **Brázda** — voják od těžkých zbraní (z kap. 1/5); mluví málo → když mluví, poslouchají; klíčová replika: NEPŮJDE k Souladu, ne kvůli číslům, ale **„nejdu sloužit nikomu, kdo si vede seznam"** (Melass = 5211 počítaných po jednom). Lidský „jiný výsledek ze stejných čísel".
- **Cuk** — mladík (z kap. 5); mluví, aby neslyšel notu v přepážkách; nahlas přizná, že Soulad „nelhal" a že nabídka dává smysl.
- **svob. Sálová** — Vosina odstřelovačka (z kap. 3/5); v hangáru čistí pušku.
- **Cassia Renn** — jen HLAS (z člunu) v závěru; spisovná, diplomatická, ale **poprvé bez druhého dna** (už nemusí lhát); vrací se OTEVŘENĚ jako vyjednavačka Smíření. Volá jmenovitě **Vos** (ne Reyevera): „s vámi se mluví líp, vy se aspoň díváte na to, co opouštíte".
- **navigátor** (bezejmenný, týž typ) — hlásí kontakt; mladý, vyspalý míň než loď.

**Klíčové události:**
1. Vos devátou noc nespí, chodí po lodi a počítá ztráty/stav. V navigaci čte registr: ne 6 (Liga, kap. 14), ale po otevření registru KONDOMINIA (kanál od Hala) **JEDNATŘICET** soustav, které za poslední rok přestaly dělat aspoň jedno ze tří (platit dávky / přijímat posádky / hlásit pohyb).
2. **Jídelna, Hale:** Vos rozloží ruční mapu lidského prostoru s křížky = 31 soustav. KANON ČÍSEL: lidstvo **187 soustav**; **3 vzal Soulad**, **9 drží otevřeně Smíření**, **19 tiše defektovalo** (ještě neřeklo nahlas, jen přestalo poslouchat); **156 papírově za Kondominiem** (většina jen proto, že „ještě nedostala nabídku"). Hale: „počtář spočítá, KDY most spadne, ne JESTLI stojí za to ho podržet". Vos přizná Halovi: žádný z 31 křížků se nemýlí — „spočítali přežití, spočítala bych to taky". Hale: „To neříkej před klukama. To si nech."
3. **Mapové stání, Reyever:** Vos mu předloží 31; Reyever: „Já vím." Vos ho konfrontuje, proč pustil nabídku Souladu nahlas a nechává mužstvo počítat s vítězem. Reyever: hlas proti matematice prohraje → nedává mužstvu hlas, dává jim TOTÉŽ co má sám = **„stejnou matematiku a jiný výsledek"**. Neodpoví Vos přímo na nic (potvrzení vztahu: Vos ho nenávidí za mlčení).
4. **Velitelské stání, depeše:** tři týdny stará civilní depeše O Kondominiu (ne OD něj). KANON ROZPADU KONDOMINIA (konkrétně, poprvé v ději ukázáno): **Třetí flotila** stažena z celého pohraničního ramene („konsolidace" = krycí slovo pro ústup); dvě domovské velmoci si VZÁJEMNĚ zablokovaly hlasy ve výboru → Kondominium **tři měsíce** nevydalo společný rozkaz; **Daňová liga východního sektoru** přestala odvádět podíl na hladinový pohon, Kondominium ji nepotrestalo (nemá čím). Logika: bez podílů nejsou lodě → bez lodí není monopol → bez monopolu Kondominium = „jméno na staré smlouvě". Vos pochopí: Kondominium nepadne v bitvě, **padne na schůzi** (ozvěna Renn z kap. 2) — umírá samo z únavy; do trhliny vráží Smíření. Vos pustí depeši nahlas do lodi (Reyeverova zásada „šeptaná zpráva hnije").
5. **Hangár, mužstvo (vnitřní krize Legie pokračuje — posádka slyšela Soulad v kap. 16):** Vos jde mezi muže. Cuk: Soulad „nelhal", nabídka dává smysl. Brázda: Vejvar umřel za vodu na Sirte, kterou nikdo nechce, pro soustavu, co Legii odepsala → Soulad MÁ PRAVDU, že příště by umřeli „za něco, co zůstane". ALE Brázda NEPŮJDE: „nejdu sloužit nikomu, kdo si vede seznam" (Melass počítán po jednom). = lidský „jiný výsledek ze stejných čísel"; Legie drží ne logikou, ale odporem k „seznamu". Vos: „To si nech. Až budeš příště počítat, vzpomeň si, žes to řekl první."
6. **Můstek, HOOK — Renn se vrací OTEVŘENĚ:** před ránem kontakt z volné vody — malé plavidlo lidské konstrukce (kondominijní kýl, starý typ) s PROUDOVOU VÝSTROJÍ (souladská technika), vyšplhalo z proudu mimo mapy. Vysílá otevřeně, žádá spojení JMENOVITĚ s Vos. Je to **Cassia Renn**. Poprvé NELŽE o tom, kdo je: „přilétám jako vyjednavačka Smíření. Ne tajně. Otevřeně, s pověřením, za stranu, která přežije." Letí sama, beze zbraně, jediným člunem. Přiváží nabídku pro celou Legii a chce, aby ji slyšela celá loď („já vím, že to plukovník udělá tak jako tak").

**Co kdo ví (stav na konci kap. 17):**
- **Vos ví:** plný rozsah štěpení lidstva (187 / 3 Soulad / 9 Smíření / 19 tiše defektovalo / 156 papírově); že Kondominium se reálně rozpadá (Třetí flotila stažena, výbor zablokován 3 měsíce, Daňová liga neplatí); že Smíření má v číslech PRAVDU a žádný z přeběhlíků se „nemýlí"; že nepřítel je i LIDSKÝ. Nese to sama, „před klukama" to neříká. Renn se vrátila jako vyjednavačka Smíření.
- **Reyever ví:** totéž (31, rozpad); jeho odpověď = „jiný výsledek ze stejných čísel", ne lepší čísla; neodpoví Vos přímo.
- **Hale ví:** Sarn má pravdu v číslech; otevřel Vos kanál k registru Kondominia; drží mužstvo, ale sám nese, že pravdu má „ten, co nic nevysvětlí".
- **Mužstvo (Brázda, Cuk):** otevřeně zvažuje, že Soulad/Smíření má pravdu (krize z kap. 16 pokračuje); Brázda formuluje důvod, proč přesto NE (odpor k „seznamu") — Legie zatím drží.
- **Renn:** vrací se OTEVŘENĚ jako vyjednavačka Smíření, s pověřením, beze lži; přiváží nabídku pro celou Legii.

**Nové zavedené detaily / fakta (držet dál):**
- **ČÍSLA ŠTĚPENÍ LIDSTVA (KANON, držet konzistentní):** **187 soustav** (= bible/kap. 16). Z toho: **3 vzal Soulad**, **9 otevřeně Smíření** (= kap. 16), **19 tiše defektovalo** (nové — ještě nepřiznaly nahlas, jen přestaly poslouchat), **156 papírově za Kondominiem**. Vosin souhrn 3+9+19 = **31 soustav „křížek"** (přestaly dělat aspoň jedno ze tří: platit dávky / přijímat posádky / hlásit pohyb). [Pozn. k souladu: kap. 14 = „6 kolonií LIGY" defektovalo; kap. 16 = „9 Smíření"; zde celkový obraz CELÉHO lidstva = 31 odpadlých, z toho 9 deklarovaných Smíření. 6 Ligy ⊂ širší obraz. Neplést úrovně: Liga ≠ celé lidstvo.]
- **VĚRNÍ × SMÍŘENÍ jako plný obraz (bible §3 v ději):** Věrní = kdo bude bojovat (156 papírově + Legie); Smíření = kdo se sklonil (9 deklarovaných + 19 tichých). Mezi tím nerozhodnutí/oportunisté. Klíč morální šedi: **Smíření má v číslech PRAVDU** (Vos: „žádný se nemýlí"; nekarikovat — bible).
- **ROZPAD KONDOMINIA UKÁZÁN KONKRÉTNĚ (nový kanon, dosud jen řečeno):** **Třetí flotila** stažena z pohraničního ramene („konsolidace" = krycí slovo pro ústup); **dvě domovské velmoci** si vzájemně zablokovaly hlasy ve výboru → **3 měsíce** bez společného rozkazu; **Daňová liga východního sektoru** přestala odvádět podíl na hladinový pohon, beztrestně. Řetěz: bez podílů → bez lodí → bez monopolu na hladinový pohon → konec Kondominia. „Padne na schůzi, ne v bitvě" (ozvěna Renn kap. 2). KANON: Kondominium umírá zevnitř/z únavy; Smíření vráží do trhliny.
- **Reyeverova formule krize:** velitel proti protivníkovi, co má pravdu v číslech, nenabízí lepší čísla, ale **„jiný výsledek ze stejných"**. Důvod, proč pustil nabídku nahlas (kap. 16): hlas proti matematice prohraje → dá mužstvu „totéž, co má sám".
- **Brázdova replika (lidský „jiný výsledek"):** „nejdu sloužit nikomu, kdo si vede seznam" — odpor k Souladu NE z čísel, ale z principu (Melass = 5211 počítáno po jednom; seznam je seznam, ať 5000 nebo já). KANON: čím Legie drží proti pokušení Souladu — ne lepšími čísly, hodnotou mimo čísla.
- **Halova metafora (most/počtář):** počtář spočítá, KDY most spadne, ne JESTLI stojí za to ho podržet hodinu, dokud po něm přejdou lidé na druhé straně. = Hale formuluje Reyeverovu logiku „skoro jako on".
- **Renn se vrací OTEVŘENĚ jako vyjednavačka Smíření** (≠ skrytě jako kontraktorka Ligy, kap. 1–14): poprvé NELŽE o tom, kdo je; pověření Smíření; letí sama, beze zbraně, jediným člunem; volá JMENOVITĚ Vos. Renin idiolekt zde: spisovný, diplomatický, ale BEZ druhého dna (už nemusí). KANON: Renn nyní deklarovaná tvář Smíření vůči Legii.
- **Renin člun:** lidská konstrukce (kondominijní kýl, starý typ) + **proudová výstroj** (souladská technika, kterou na takovou loď nikdo nemontuje) → vyšplhá z proudu mimo mapy (ozvěna doprovodného člunu kap. 14). KANON: Smíření vybavuje lidské lodě souladskou proudovou technikou.
- **Hale otevřel Vos neevidovaný kanál** k registru Kondominia („velitel by to chtěl vidět, i kdyby to nepřiznal") — Hale jako lepidlo/zákulisí jednotky.
- Vosin podpis potvrzen: naštvaná = ztiší se; jde mezi mužstvo (poprvé do hangáru jako major); nese špatnou zprávu první, aby ji druzí dostali „už nesenou".

**Jak kapitola končí:**
Renn volá z člunu před ránem, otevřeně jako vyjednavačka Smíření, jmenovitě Vos. Poprvé bez druhého dna: „Pusťte mě dovnitř, majorko. Přivezla jsem vám nabídku pro celou Legii. A tentokrát ji slyšte celá loď. Já vím, že to plukovník udělá tak jako tak." (= Renn se vrací OTEVŘENĚ; přiváží nabídku Smíření přímo na *Kovadlinu*.)

**Otevřené nitky (→ kap. 18 „Klín"):**
- **Renn na palubě s nabídkou Smíření pro celou Legii** → přímo živí kap. 18 (konfrontace Reyever × Sarn tváří v tvář; „já nejsem zrádce, jsem ten, kdo počítal"); Renn jako Sarnova vyjednavačka může zprostředkovat setkání/uzel.
- **Vnitřní krize Legie eskaluje** (Brázda/Cuk otevřeně zvažují pravdu Smíření, ale drží odpor k „seznamu") → kap. 18 (vlastní lidé poprvé OTEVŘENĚ zvažují, že Sarn má pravdu) a kap. 19 (vzpoura na hraně).
- **Linka Vos ↔ Renn** (pátračka × hráčka; Vos ji „nechala jít" kap. 14) pokračuje: Renn volá jmenovitě Vos, bez lži — dluh/vina z kap. 14 se vrací ke konfrontaci tváří v tvář.
...
## Kap. 19 — „Vzpoura na hraně"

> **AKT III (SOULAD).** Charakterní/napjatá (dechová, bez přestřelky) kapitola po konfrontační kap. 18. Navazuje bezprostředně: **11. den oprav** *Kovadliny*, den/dny po Sarnově odletu (kap. 18). Žádný boj — napětí drží vnitřní krize Legie, dialog, podtext. KLÍČOVÉ: vnitřní vzpoura Legie vrcholí; Hale drží jednotku (duše Legie, lidská míra); Vos KONEČNĚ pochopí cenu Reyeverova mlčení (Sirte); Smíření přitvrdí (ULTIMÁTUM, lhůta 6 dní přes Renn); skoro-vzpoura. HOOK: Reyever oznámí PLÁN, který zní jako KAPITULACE (ve skutečnosti past u uzlu, posádka ani čtenář to neví).

**POV:** št. rtm. Brannick „Kovář" Hale (hlavní ohnisko první půle) + mjr. Iliana Vos (druhá půle). Vševědoucí 3. os., přítomný čas. Reyever vstupuje jako hlas/přítomnost, vrcholí jako mluvčí v závěru; NE jako POV.

**Místo:** těžký křižník **Kovadlina** v opravách v mělčině. Lokace: **Halova dílna** (studená svářečka) → **hangár za odstavenými transportéry** (mužstvo; táž lokace co kap. 5/17) → **dokovací límec / přepážka** (Hale × Vos) → **velitelské stání** (Vos čte ultimátum) → **mapové stání** (Vos × Reyever, prázdná červená mapa, táž lokace co kap. 16/17) → zpět **hangár** (Reyeverovo oznámení plánu celé jednotce).

**Denní doba / čas:** 11. den oprav (postup časové kotvy: kap. 15 = 6., 16 = 8., 17 = 9., 18 = 10., 19 = **11. den**). Kapitola = jeden den do noci a další ráno (Halova noční dílna → hangár → noční ultimátum → ranní/denní svolání).

**Jmenované postavy (přesné tvary):**
- **št. rtm. Brannick „Kovář" Hale** — POV (1. půle); obecná čeština, řemeslné metafory (svářečka, kanón, most s prasklým nosníkem, beton), černý humor jako ventil i ve vypjaté chvíli. Drží mužstvo SLOVEM i rukama; sám nahlas přizná, že na to, co by měl mít velitel, nemá (důvod mimo Sarnovu tabulku má jen Reyever). Slyší, jak chlapi „počítají" potichu.
- **mjr. Iliana Vos** — POV (2. půle); naštvaná = ZTIŠÍ se; nese špatnou zprávu první (ultimátum); pustí ho do lodi nesestříhané (Reyeverova zásada „šeptaná zpráva hnije"). KONEČNĚ pochopí cenu Reyeverova mlčení o Sirte.
- **plk. Adan Reyever** — hlas/přítomnost, vrcholí jako mluvčí; úsporný, nezvyšuje hlas; prasklé žebro z kap. 13 stále bodá (časová kotva). Oznámí plán, který zní jako kapitulace.
- **Brázda** — voják od těžkých zbraní (kap. 1/5/17); mluví málo → mluví za celý hangár; dva dny nedává dohromady rozložený těžký kanón (= nedává dohromady sebe); nahlas: „admirál má pravdu / za co tady ještě sedím". V závěru kanón složí (Halovo „slož ten kanón").
- **Cuk** — mladík (kap. 5/17); poprvé MLČÍ (dřív mluvil, aby neslyšel notu v přepážkách).
- **svob. Sálová** — Vosina odstřelovačka (kap. 3/5/17); čistí pušku, suchý humor.
- **Cassia Renn** — NEvystupuje fyzicky; její je krutě prostá věta v ultimátu („šest dní vám neklademe my, klade je vaše loď; spočítejte, jak dlouho klín udrží jeden zub").
- **adm. Dane Sarn** — NEvystupuje; ultimátum je „v tvaru jeho písma"; spoléhá na matematiku (kap. 18).

**Klíčové události:**
1. **Halova dílna (noc):** Hale stojí nad studenou svářečkou — znamení, že je na lodi něco, co se svářečkou nespraví. Slyší TICHO v hangáru a v něm, jak mužstvo potichu „počítá" (Sarnova matematika z kap. 18 zraje). Jde to řešit.
2. **Hangár, Hale × mužstvo (vrchol vnitřní krize):** Brázda mluví za celý hangár: spočítal to, admirál/Soulad MÁ PRAVDU, Kondominium se rozpadá, plukovník i nepřítel mají pravdu zároveň → „za co tady ještě sedím?". Hale ODDĚLÍ DVĚ VĚCI (klíčový beat = Halova verze Reyever/Hale linie „jiný výsledek ze stejných čísel" z kap. 17/18): (a) Sarnova čísla SEDÍ, kdo to popírá je blbec; ALE (b) spočítat, KDY stroj chcípne, umí každý s tabulkou — jestli stojí za to podržet most ještě hodinu, dokud po něm přejdou lidi na druhé straně, to v tabulce není, „to je v tobě"; kdo má pravdu v číslech a tohle v sobě nemá, „bude mít pravdu a bude svině, obojí naráz". Drží mužstvo na tak dlouho, než dojdou ke kavalcům; SÁM uzná, že to nedrží natrvalo — chybí důvod mimo tabulku, který má z lodi jediný Reyever.
3. **Přepážka, Hale × Vos:** Hale přizná, že „drží to jako most s prasklým nosníkem". Naznačí Vos, že VÍ něco o Sirte „očima montéra" (ne to, co ví Reyever) a že by Vos měla přestat počítat Reyeverův rozkaz ze Sirte jako URÁŽKU a začít ho počítat jako CENU — ale nechá to na později, „lidi počkají, loď ne".
4. **Velitelské stání, ULTIMÁTUM (Smíření přitvrdí):** přijde ČERSTVÁ zpráva (špatné znamení — někdo umí proudy mimo mapy). Je to ultimátum Smíření: **6 DNÍ** dovléct se k proudovému uzlu (Smíření tam drží otevřenou hladinu) a buď přijmout přesazení pod prapor Smíření, nebo se postavit tomu, co u uzlu čeká. Připsaná RENNINA věta: lhůtu neklade Smíření, klade ji vlastní rozbitá loď (klín o jeden zub) — „spočítali jsme to za vás". Vos: lhůta je PŘESNÁ (= co dává sama loď); Sarn nemusí vyhrožovat, jen čte stejnou tabulku jako Hale. Vos pustí ultimátum do lodi celé.
5. **Mapové stání, Vos × Reyever — VOS POCHOPÍ CENU MLČENÍ (jádro kapitoly):** Vos žádá, ať Reyever dá mužstvu DŮVOD mimo Sarnovu tabulku, řekne ho nahlas. Reyever MLČÍ — a Vos POPRVÉ za dva roky v tom mlčení nevidí odpírání odpovědi, ale muže, který odpověď NEMÁ v tvaru, jaký by šel dát (slovo proti matematice prohraje → zbývá ČIN, a čin se neoznamuje předem). Z toho Vos rozluští SIRTE (kap. 3): Reyever jí neřekl proč, protože kdyby věděla, že fixuje obranu čelem pro obchvat druhého družstva bokem, hrála by to jinak (líp by se kryla) a obránci/nepřítel by past prokoukli; potřeboval ji DOOPRAVDY v nebezpečí, aby tomu uvěřil i nepřítel; cenu NESL SÁM, aby ji nemusel rozdělit na ty, kdo by ji prozradili tím, že o ní vědí. Reyever neřekne ano ani ne (= u něj celá řeč). Vyřkne to, co Reyever řekl už v kap. 5: „velitel, který vysvětluje, je velitel, kterého lze přemluvit" + nový dovětek: nepřítel, který ví, že velitele lze přemluvit, na něj přestane střílet a začne s ním mluvit (to je horší — viděno u Sarna). Vos POPRVÉ přikývne BEZ zlosti (smíření Vos × Reyever; převzetí břemene — viz oblouk Vos). Na otázku, co udělá u uzlu, Reyever: „Nic, co bych ti řekl. Z téhož důvodu."
6. **Hangár, ZÁVĚR — Reyever oznámí PLÁN (HOOK):** Reyever svolá důstojníky/poddůstojníky DO HANGÁRU (gesto: přišel za nimi). Nezvyšuje hlas. Místo povzbuzení dá mužstvu HOLOU PRAVDU NEPŘÍTELE: Sarn má pravdu, Soulad má pravdu, Kondominium se rozpadá. Pak oznámí plán: u uzlu doplujeme k Sarnově otevřené hladině, PŘIJMEME JEDNÁNÍ otevřeně na pásmu, které slyší obě flotily, předáme souřadnice KAPITULACE a podmínky přesazení Legie pod prapor Smíření — BEZ VÝSTŘELU, bez mrtvého navíc, „tak, jak to chce admirál". Rozkaz: „Připravte loď na kapitulaci u uzlu. Do posledního zubu na klínu." Odejde, nechá hangár, který neví NIC (úleva, nebo vzpoura?). Jen Vos (která ho 2 hod předtím pochopila) slyší pod tím druhé: „čin se neoznamuje předem" → tuší, že Reyever před celou lodí NAHLAS ZALHAL, a je jediná na palubě, kdo ví, že lže PRO NĚ (připravuje past u uzlu, NE skutečnou kapitulaci).

**Co kdo ví (stav na konci kap. 19):**
- **Hale ví:** vnitřní krize je na hraně; udržel mužstvo slovem (oddělil „čísla sedí" od „důvod podržet most"), ale natrvalo to nedrží bez Reyeverova důvodu mimo tabulku; tuší cosi o Sirte „očima montéra"; po Reyeverově oznámení (jako všichni krom Vos) NEVÍ, že kapitulace je léčka.
- **Vos ví:** plně pochopila cenu Reyeverova mlčení (Sirte i teď) — mlčení = nutnost, ne arogance; smířila se s Reyeverem bez zlosti; a JAKO JEDINÁ na palubě TUŠÍ, že oznámená „kapitulace" je ČIN/past, ne skutečné vzdání se (Reyever jí přímý plán NEŘEKL, ale dala si dohromady „čin se neoznamuje předem"). Nese to sama.
- **Reyever ví:** plán (past u uzlu pod rouškou kapitulace) — nikomu ho neoznámil, ani Vos ne explicitně; vědomě před lodí pronesl, co zní jako kapitulace, protože „šeptaná/oznámená past hnije" a slovo proti matematice prohraje, kdežto čin ne.
- **Mužstvo (Brázda, Cuk, Sálová, noční směna):** slyšeli holou pravdu nepřítele z velitelových úst + oznámení kapitulace; NEVÍ, co si o tom myslet (hangár „neví vůbec nic"); NEVÍ o pasti.
- **Smíření (Sarn/Renn):** dali 6denní ultimátum (= čas, co dává sama rozbitá loď); čekají u uzlu na přesazení Legie; spoléhají na matematiku.

**Nové zavedené detaily / fakta (držet dál):**
- **ULTIMÁTUM SMÍŘENÍ — lhůta 6 DNÍ** dovléct se k proudovému uzlu a buď přijmout přesazení, nebo se postavit tomu, co u uzlu čeká. KANON: lhůta NENÍ libovolná — rovná se času, který dává sama poškozená *Kovadlina* (klín drží o jeden zub); „spočítali jsme to za vás" (Rennina věta). Sarn nemusí vyhrožovat, jen čte stejnou tabulku co Hale beze svářečky. → časový tlak na kap. 20 (bitva u uzlu).
- **Halovo ODDĚLENÍ DVOU VĚCÍ** (jeho verze „jiný výsledek ze stejných čísel" z kap. 17/18): (1) Sarnova čísla SEDÍ (fakt, nezpochybnitelný); (2) „spočítat, KDY most spadne, umí každý; jestli stojí za to ho podržet hodinu, než po něm přejdou lidi, to v tabulce není — to je v tobě." Pravda v číslech bez tohohle = „pravdu máš a jsi svině, obojí naráz". KANON: čím Legie drží zevnitř (hodnota mimo tabulku), kontinuálně s Brázdou kap. 17 a Reyeverem kap. 18.
- **VOS POCHOPÍ CENU REYEVEROVA MLČENÍ (uzavření jádra vztahu Vos × Reyever ze Sirte, kap. 3/5):** Reyeverův nevysvětlený rozkaz na Sirte (Vos fixuje obranu ČELEM, aby ji 2. družstvo OBEŠLO BOKEM) NESMĚL být vysvětlen, protože kdyby Vos věděla, hrála by to jinak (líp by se kryla), nepřítel/obránci by past prokoukli a nesklapla by; Reyever potřeboval Vos DOOPRAVDY ohroženou, aby uvěřil i nepřítel; cenu NESL SÁM, aby ji nemusel rozdělit na ty, kdo by ji prozradili tím, že o ní vědí. KANON: mlčení = struktura velení proti přemluvení/prozrazení, ne nedůvěra ani arogance. Vos se SMÍŘÍ bez zlosti (oblouk: převzetí břemene). [Pozn.: Reyever to NEPOTVRDÍ slovy — „neřekne ano ani ne"; pravdivost dovození drží Vosino čtení, ne Reyeverovo přiznání.]
- **Reyeverova zásada rozšířena:** „velitel, který vysvětluje, je velitel, kterého lze přemluvit" (kap. 5) + dovětek: „nepřítel, který ví, že velitele lze přemluvit, na něj přestane střílet a začne s ním mluvit — a to je horší" (viděno u Sarna, kap. 15/18). Důsledek pro kap. 19: proti matematice nelze bránit SLOVEM (prohraje), zbývá ČIN, a „čin se neoznamuje předem".
- **PLÁN-KAPITULACE (HOOK, klíčový kanon pro kap. 20):** Reyever před CELOU LODÍ otevřeně oznámí, že u uzlu PŘIJME jednání a KAPITULUJE — předá souřadnice kapitulace a podmínky přesazení Legie pod prapor Smíření, bez výstřelu. ZNÍ to jako kapitulace; VE SKUTEČNOSTI je to PŘÍPRAVA PASTI u uzlu (potvrzeno synopsí kap. 20: Reyever vláká souladskou žací flotilu i Sarnovy lodě do gravitační pasti využitím znalosti PROUDŮ). Posádka ANI ČTENÁŘ to v kap. 19 ještě NEVÍ; jediná Vos TUŠÍ (z „čin se neoznamuje předem"), že jde o léčku. KANON pro kap. 20: „kapitulace" = krycí manévr; rozkaz „připravte loď na kapitulaci do posledního zubu na klínu" = ve skutečnosti připravte loď k boji/manévru. NEPROZRADIT mechaniku pasti dřív než kap. 20.
- Brázda dva dny nedává dohromady rozložený těžký kanón (= obraz „nedává dohromady sebe"); v závěru ho na Halovo pobídnutí složí. Cuk poprvé MLČÍ. Sálová čistí pušku (stálý motiv kap. 3/5/17).
- Halovy metafory rozšířeny: studená svářečka v ruce = na lodi je něco, co se svářečkou nespraví; „most s prasklým nosníkem — stojí, ale netancoval bych po něm"; beton (odpověď, co věc jen zalije a pak se musí odsekávat). „Lidi se opraví hůř než lodě, ale aspoň počkají."
- **Prasklé žebro Reyevera** (kap. 13) stále bodá = časová kotva (11. den oprav).
- Vosin podpis potvrzen: naštvaná = ZTIŠÍ se; nese špatnou zprávu první; pustí ji do lodi celou nesestříhanou; tělo dohání tvář o setinu vteřiny (od Reyevera, nenávidí to).

**Jak kapitola končí:**
Reyever v hangáru oznámí, že u uzlu KAPITULUJE (předá souřadnice kapitulace a přijme přesazení pod prapor Smíření, bez výstřelu), rozkáže „připravte loď na kapitulaci do posledního zubu na klínu" a odejde. Hangár neví nic (úleva, nebo vzpoura?). Vos jediná slyší pod tím „čin se neoznamuje předem" a tuší, že Reyever před celou lodí NAHLAS ZALHAL — a je jediná na palubě, kdo ví, že lže PRO NĚ (kapitulace = past, ne vzdání se). Pointa: přeje si, aby se mýlila.

**Otevřené nitky (→ kap. 20 „Proudový uzel"):**
- **PLÁN-KAPITULACE = PAST u uzlu** (Reyever využije znalost proudů, vláká souladskou žací flotilu i Sarnovy lodě do gravitační pasti) → přímo spouští bitvu kap. 20 (vrchol flotilní taktiky: klín, clony, křížení T, mělčina jako past). Posádka/čtenář se pravou povahu „kapitulace" dozví AŽ v kap. 20. Vos tuší.
- **6denní lhůta** = časový rámec přesunu k uzlu a bitvy (kap. 20).
- **Vnitřní krize Legie** kulminovala a je dočasně udržena (Hale + Reyeverovo oznámení), ale NEVYŘEŠENA — drží na vlásku; rozhodne se až výsledkem u uzlu (kap. 20/21: „Soulad krvácí" = jiný výsledek ze stejných čísel v praxi, ne argumentem).
